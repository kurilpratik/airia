  ...
  return (
    <main className="flex min-h-screen flex-col md:flex-row">
      ...
      {/* <div className="flex flex-col w-full md:w-1/2 bg-gray-100 p-8">
       ...
       <div className="w-1/2 p-5 border">
        <h2  className="text-xl font-bold ">Code Suggestions</h2>
        {loading ? <div class="h-screen">
...
<div class="loader">
  ...
  <div class="dot dot-5"></div>
          ...
          <Card className="my-6 py-0 shadow-md  overflow-hidden">
            {
              suggestions ? <SyntaxHighlighter language="html" style={atomDark} customStyle={{ margin: 0, borderRadius: 0 }}>
              {/* {sampleCode["app/layout.jsx"]} */}
